...
func main() {
	...
	sendEmailConsumer := consumer.NewSendEmailConsumer(context.Background())
	...
	case queue.ProcessSendEmail:
		...
		go app.queue.HandleConsumedDeliveries(queue.ProcessSendEmail, sendEmailConsumer.Process)
	default:
